...
<body class="<?php print $body_classes; print arg(1); print arg(2); print arg(3); print ' '. $title .' ';?>" <?php print $background_tag; ?> >
...
<?php print $skinr; ?>
  <div id="header">
    ...
    <div id="logo">
      ...
      <div class="social-wrapper">
		  ...
		  <div class="social-links">
			  <a href="http://www.facebook.com/pages/UCLA-Luskin-Center-for-Innovation/157333557610562?ref=sgm"><img src="/<?php print path_to_theme()?>/images/facebook-big.png"/></a>
    ...
    <a style="clear: both; float: right;" href="/content/newsletter-sign" id="newsletter-signup">Sign up for our newsletter</a>
    </div>
    <?php print $header; ?>
